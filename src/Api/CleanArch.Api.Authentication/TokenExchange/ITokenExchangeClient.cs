...
internal interface ITokenExchangeClient
{
    ...
    Task<ExchangedToken> ExchangeAsync(string subjectToken, CancellationToken cancellationToken);
}
...
{
    public TokenExchangeException(TokenExchangeFailure failure, string message, Exception? innerException = null)
