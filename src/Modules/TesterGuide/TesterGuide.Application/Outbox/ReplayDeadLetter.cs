...
/// <summary>
/// Requeues a dead-lettered Tester Guide outbox message for redelivery. Not an <c>ITesterGuideCommand</c>:
/// it's a standalone admin operation, so the shared OutboxReplayer commits its own change.
/// </summary>
